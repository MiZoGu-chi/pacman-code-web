...
import com.pacman.view.states.State;
import com.pacman.view.states.StateInit;
...
public class ViewCommand implements PropertyChangeListener {
    ...
    public ViewCommand(Game game, AbstractController controller) {
        ...
        pauseIcon = new ImageIcon("src/main/webapp/images/icon_pause.png");
        restartIcon = new ImageIcon("src/main/webapp/images/icon_restart.png");
        runIcon = new ImageIcon("src/main/webapp/images/icon_run.png");
        stepIcon = new ImageIcon("src/main/webapp/images/icon_step.png");
